...
// 정본 문서: docs/04-imaging/exposure-merge.md §4, §5
//
// **P0 비트 동일 대상이다.** 결과가 macOS 와 한 비트라도 다르면 같은 필름을
// 두 OS 에서 스캔했을 때 다른 픽셀이 나온다.
// 근거: docs/04-imaging/numerical-parity.md §3.1
//
// ## Core Image 를 걷어냈다
//
...
/// 근거: docs/04-imaging/exposure-merge.md §8
...
/// 근거: docs/04-imaging/exposure-merge.md §4.3
...
/// 근거: docs/04-imaging/exposure-merge.md §5
