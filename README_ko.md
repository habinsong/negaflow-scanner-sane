...
|---|---|---|
| `negaflow-scanner-sane-1.0.3-macos-arm64-installer.dmg` | 일반판, macOS 14 이상 | `arm64` 전용 |
| `negaflow-scanner-sane-1.0.3-macos-universal-installer.dmg` | 일반판, macOS 14 이상 | `arm64` + `x86_64` |
| `negaflow-scanner-sane-1.0.3-coolscan-macos26-arm64-installer.dmg` | Coolscan 패치판, macOS 26 이상 | `arm64` 전용 |
| `negaflow-scanner-sane-1.0.3-coolscan-macos26-universal-installer.dmg` | Coolscan 패치판, macOS 26 이상 | `arm64` + `x86_64` |
