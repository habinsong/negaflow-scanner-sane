...
|---|---|---|
| `negaflow-scanner-sane-1.0.2-macos-arm64-installer.dmg` | 標準版、macOS 14以降 | `arm64`のみ |
| `negaflow-scanner-sane-1.0.2-macos-universal-installer.dmg` | 標準版、macOS 14以降 | `arm64` + `x86_64` |
| `negaflow-scanner-sane-1.0.2-coolscan-macos26-arm64-installer.dmg` | Coolscan修正版、macOS 26以降 | `arm64`のみ |
| `negaflow-scanner-sane-1.0.2-coolscan-macos26-universal-installer.dmg` | Coolscan修正版、macOS 26以降 | `arm64` + `x86_64` |
